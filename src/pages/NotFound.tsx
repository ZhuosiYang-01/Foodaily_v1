...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-8 text-center space-y-8 animate-in fade-in duration-500">
      <div className="w-32 h-32 bg-gray-50 rounded-[3rem] flex items-center justify-center text-gray-200 shadow-inner">
        <Coffee size={64} />
      </div>
      <div className="space-y-2">
        <h1 className="text-4xl font-bold serif text-gray-900">404</h1>
        <p className="text-sm text-gray-400 italic">哎呀，这个页面好像被吃掉了 ✨</p>
      </div>
      <Button 
        onClick={() => navigate('/')}
